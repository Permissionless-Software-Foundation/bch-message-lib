...
class Merit {
  ...
  //
  // CT 6/5/21: This function needs to be updated to handle the corner-case of
  // when there are multiple parent UTXOs, as illustrated in this TXID:
  // 78f8d849032dd34a3f86fa87e7eeb7ccb5c07794bd910d5b9fab29d7706c3b3d
  // It needs to iterate through an array of parents to find the oldest one,
  // and then return that oldest one.
      ...
      for (let i = 0; i < parentUtxos.length; i++) {
        ...
        if (match.length > 0) {
          ...
          for (let j = 0; j < match.length; j++) {
            ...
            // console.log(`hydratedData: ${JSON.stringify(hydratedData, null, 2)}`)
